            ...
            <main className="main-content">
                <section className="hero-section fade-in">
                    <div className="hero-content">
                        ...
                        <p className="hero-subtitle">
                            Create a stunning portfolio that showcases your
                            work, attracts opportunities, and tells your unique
                ...
                <section className="features-section">
                    <div className="section-header">
                        ...
                        <p className="section-subtitle">
                            Powerful features designed to make your portfolio
                            stand out
                        </p>
                    </div>
                    ...
                    <div className="features-grid">
                        {features.map((feature, index) => (
                            ...
                            >
                                <div
                                    className={`feature-icon-bg gradient-${index}`}
                                >
                ...
                <section className="portfolios-section">
                    <div className="section-header">
                        <h2 className="section-title">
                            Portfolio{' '}
                            <span className="highlight">Showcase</span>
                        </h2>
                        <p className="section-subtitle">
                    ...
                    <div className="testimonial-container">
                        <div className="testimonial-header">
                            ...
                            <h2 className="testimonial-title">
                                Loved by{' '}
                                <span className="highlight">Creatives</span>{' '}
                                Worldwide
                            </h2>
                        </div>
                            ...
                            <div className="testimonial-card">
                                <div className="testimonial-content">
                                    <p className="testimonial-text">
                                        PortfolioPro helped me land 3x more
                                        interviews. The clean design impressed
                                        every recruiter who saw it.
                                    </p>
                                </div>
                    ...
                    <div className="cta-container">
                        <div className="cta-content">
                            <h2 className="cta-title">
                                Ready to{' '}
                                <span className="highlight">Elevate</span> Your
                                Career?
                            </h2>
                            <p className="cta-subtitle">
                                Join thousands of professionals who've
                                transformed their job search with PortfolioPro
                            </p>
    ...
    <div className="flex flex-col md:flex-row md:justify-between gap-12">
      ...
      <div>
        <div className="text-2xl font-bold text-gray-900 dark:text-white">
          Portfolio<span className="text-indigo-600 dark:text-indigo-400">Pro</span>
        </div>
...
<div>
  ...
  <ul className="footer-list">
    ...
    {/* Bottom */}
    <div
      className="mt-14 pt-6 border-t border-gray-200 dark:border-white/10
